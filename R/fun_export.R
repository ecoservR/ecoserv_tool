...
#' @param tiles Should the basemap be exported as 10x10km tiles? Defaults to FALSE but may be required for large study areas which may take a long time to render in a GIS software.
#' @return Saves a project_title_final.RDS and a project_title_final.gpkg file to project folder.
#' @export
#'
